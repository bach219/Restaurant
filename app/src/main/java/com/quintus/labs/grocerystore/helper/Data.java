...
//        categoryList.add(category);
    ...
    public List<Product> getProductList() {
        Product product = new Product("1", "2", "Bánh mì như ý", "", "1 suất", "20000", "", "https://images.foody.vn/res/g77/769242/prof/s576x330/foody-upload-api-foody-mobile-057bb011889c69c2308d-180822162906.jpg");
        productList.add(product);
        product = new Product("2", "1", "Trà chanh", "", "1 ly", "10000", "", "https://www.unileverfoodsolutions.com.vn/dam/global-ufs/mcos/phvn/vietnam/calcmenu/recipes/VN-recipes/other/energizing-lemon-tea/main-header.jpg");
        productList.add(product);
        product = new Product("3", "2", "Nước cam", "", "1 ly", "15000", "", "https://photo-cms-plo.zadn.vn/Uploaded/2021/ycivopcg/2020_04_04/hinh-cam-vat_ltvp.jpg");
        productList.add(product);
        product = new Product("4", "3", "Xôi xá xíu", "", "1 suất", "25000", "", "https://1.bp.blogspot.com/-USUIhPdsJqY/W85WoGlyHKI/AAAAAAAALwY/sQwZecIa9HQ0O7Q2UZb5B-BTI1nXY2yNgCEwYBhgL/s1600/IMG_2059.JPG");
        productList.add(product);
        product = new Product("5", "3", "Xôi xéo", "", "1 suất", "10000", "", "https://xebanhmithonhiky.vn/wp-content/uploads/2020/09/cach-lam-xoi-xeo-de-ban.jpg");
        productList.add(product);
        product = new Product("6", "4", "Khoai tây chiên ", "", "1 suất", "20000", "", "https://4.bp.blogspot.com/-rN6xH0gyi8g/XlEh_Wab9qI/AAAAAAAACAg/JQoE5WtBVPENqXSoAkGjF3bjQYyj-E2XgCK4BGAYYCw/s640/unnamed%2B%25281%2529.jpg");
        productList.add(product);
        product = new Product("7", "4", "Xúc xích", "", "1 cái", "10000", "", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIIKlXC4DF4ORsIGGJUbmdlypA4pyUwTxLdQ&usqp=CAU");
        productList.add(product);
        return productList;
    }
