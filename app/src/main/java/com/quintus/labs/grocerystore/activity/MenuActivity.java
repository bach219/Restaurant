...
public class MenuActivity extends AppCompatActivity {
    ...
    private CardView mainOrder;
    private CardView profile;
    private CardView processOrder;
...
//        menuItem.setIcon(Converter.convertLayoutToImage(MenuActivity.this, cart_count, R.drawable.ic_shopping_basket));
//
//        return true;
//    }
//
...
//        displaySelectedScreen(R.id.nav_home);
        this.attendance = (CardView) this.findViewById(R.id.attendance);
        this.mainOrder = (CardView) this.findViewById(R.id.mainOrder);
        this.processOrder = (CardView) this.findViewById(R.id.processOrder);
        this.profile = (CardView) this.findViewById(R.id.profile);
        ...
        mainOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {Fragment fragment = new ProfileFragment();
                FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.slide_from_right, R.anim.slide_to_left);
                ft.replace(R.id.content_frame, fragment);
                ft.commit();
